  ...
  return (
    <div>
      ...
      <div className="pub-form-container">
        <form onSubmit={handleFormSubmit} className="pub-settings-form">
          <div>
            <h1>User Settings</h1>
          </div>
          ...
          <div className="pub-form-group">
            ...
            <div className="pub-password-input-container">
              <input
              ...
              <FontAwesomeIcon
                ...
                className="pub-toggle-password-icon"
          ...
          {successMessage && (
            <div className="pub-success">{successMessage}</div>
          )}
          <div className="pub-form-group">
            <button type="submit" className="pub-settings-button">
              Save Changes
            </button>
          </div>
        </form>
