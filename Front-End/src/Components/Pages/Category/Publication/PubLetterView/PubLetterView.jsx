...
const PubLetterView = () => {
  ...
  return (
    <div className="pub-view-letter-container">
      <div className="pub-header">
        <FaTimes
          className="pub-close-icon"
          onClick={() => navigate("/Pub-letterlist")}
        />
      </div>
      <div className="pub-content">
        <div className="pub-iframe-container">
          <iframe
            src={fileUrl}
            className="pub-file-viewer"
            title="file-viewer"
          ></iframe>
        </div>
        <div className="pub-remarks-container">
          <form onSubmit={handleSubmit}>
            <div>
              <h1>Remarks</h1>
            </div>
            <div className="pub-designation-radiobuttons">
              {designations.map((designation) => (
                <div key={designation} className="pub-radiobutton">
                  <div className="pub-designation-row">
                    <input
                  ...
                  {remarks[designation] && (
                    <div className="pub-remark-box">
                      <p className="pub-remark-text">
                        {remarks[designation]?.remark}
                      </p>
                      <small className="pub-text-muted">
                        {new Date(
            ...
            {!isLetterCompleted && (
              <button
                ...
                className="pub-mark-complete-button"
              >
                Mark as Complete
              </button>
            )}
